...
/* compile: gcc -o cairo_blinddown cairo_blinddown.c `pkg-config --libs --cflags gtk+-2.0` 
 * run:		./cairo_blinddown
 */
...
int main(int argc, char *argv[])
{
  ...
  image = cairo_image_surface_create_from_png("tue.png");
  ...
  gtk_window_set_default_size(GTK_WINDOW(window), 500, 288); 
