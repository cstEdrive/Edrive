...
void* MenuThread(void* pvoid)
{
    ...
    u1ini("/usr/local/Matlab7/rtw/c/ectarget/ectarget.u1");
...
/* start timer */
    printf("ECtarget v1.3 SOEM, M.J.G. v.d. Molengraft & IME Technologies, 2009\n");
    ...
    *(netif+4)='\0';
    ...
    rtc_timer(Freq,user_apc); /*startup and execution Real-Time process*/
