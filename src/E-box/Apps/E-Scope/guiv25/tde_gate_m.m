...
case def.CALL_TDE_GET_INFO
    [argout0,argout1,argout2]=tde_gate(varargin{1});
    varargout(1)={argout0};
    varargout(2)={argout1};
    varargout(3)={argout2};
case def.CALL_TDE_TRIGGER_ON
    [argout0]=tde_gate(varargin{1},varargin{2},varargin{3},varargin{4},varargin{5},varargin{6},varargin{7});
    varargout(1)={argout0};
case def.CALL_TDE_TRIGGER_OFF
    [argout0]=tde_gate(varargin{1});
    varargout(1)={argout0};
case def.CALL_TDE_CHECK_CLIPPING
    [argout0,argout1]=tde_gate(varargin{1});
    varargout(1)={argout0};
    varargout(2)={argout1};
